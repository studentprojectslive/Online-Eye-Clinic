	...
	if(document.form1.bname.value=="")
	{
        ...
        <table width="595" border="0">
          <tr>
            ...
            <input class="right" name="aname" type="text" id="aname" size="50" value="<?php   echo $adname ;?>"/></td>
          </tr>
          <tr>
            <td height="35"><label  class="left" for="loginid" >Login ID:</label></td>
            <td><input  class="right" name="loginid" type="text" id="loginid" size="50" readonly="readonly" value="<?php   echo $loginid ;?>" /></td>
          </tr>
          <tr>
            <td height="35">Email-ID</td>
            <td><input name="emailid" type="text" id="emailid" size="50" value="<?php   echo  $email_id;?>" /></td>
          </tr>
          <tr>
