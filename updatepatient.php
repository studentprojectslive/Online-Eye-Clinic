		...
		else if(type_end.toUpperCase()<"A" || type_end.toUpperCase()>"Z")
		{
          ...
          <form name="form1" id="form1" method="post" action="" onsubmit="return validation()"  >
            ...
            <tr>
                ...
                <td width="388"><input type="hidden" name="patid" value="<?php   echo $patid;?>"  />                  <input class="right" name="name" type="text" id="name" size="50" value="<?php   echo $patname;?>" /></td>
              </tr>
              <tr>
                <td><label for="dob" class="left">Gender:</label>
                <label></label></td>
                <td>
                <input name="gender" type="text" class="right"  id="gender" size="50" value="<?php   echo $gender;?>" readonly="readonly" /></td>
              </tr>
              <tr>
                <td><label for="dob" class="left">Date Of Birth:</label></td>
                <td><script type="text/javascript" src="datetimepicker.js"></script>
                <input type="Text" name="dob" id="demo1" maxlength="25" size="25"  value="<?php   echo $dob ;?>"><a href="javascript:NewCal(demo1,ddmmmyyyy,false,24)"><img src="cal.gif" width="16" height="16" border="0" alt="Pick a date"></a></td>
              </tr>
              <tr>
                <td valign="top">Address:</td>
                <td><textarea class="right" name="address" cols="39" rows="5" wrap="physical" id="address"><?php   echo $address;?></textarea></td>
              </tr>
              <tr>
                <td><label for="contact" class="left" >Contact No.:</label>
                <br /></td>
                <td><p>
                  <input name="contact" type="text" class="right" id="contact" size="50" value="<?php   echo $contact;?>"/>
                </p></td>
              </tr>
              <tr>
                <td >Email- ID:</td>
                <td><input name="emailid" type="text" class="right"  id="emailid" size="50" value="<?php   echo $emailid;?>"/></td>
              </tr>
              <tr>
