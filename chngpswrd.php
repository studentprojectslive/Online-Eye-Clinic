...
{
	?>
 <input  class="right" name="loginid" type="text" id="loginid" size="50" value="<?php   echo $_SESSION[login_id]; ?>" />
 <?php  
}
elseif($_SESSION["logtype"]==Doctor)
{
	?>
	 <input  class="right" name="loginid" type="text" id="loginid" size="50" value="<?php   echo $_SESSION[login_id]; ?>" readonly="readonly" />
<?php  
}
else
{
