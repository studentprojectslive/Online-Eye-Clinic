...
//echo mysqli_num_rows($resultquery);
            ...
            <tr>
              ...
              <td colspan="3">
              <input name="name" class="right" type="text" id="name" size="50" value="<?php   echo $rowrec[name]; ?>" />
              </td>
            </tr>
            <tr>
              <td height="33"><strong>
            ...
            <tr>
              ...
              <td colspan="3"><input name="cost" type="text" class="right" id="cost" size="50" value="<?php   echo $rowrec[cost]; ?>" /></td>
            </tr>
            <tr>
              <td height="31"><strong>
            ...
            <tr>
              ...
              <td colspan="3"><input name="qty" class="right" type="text" id="qty" size="10" value="<?php   echo $rowrec[quantity]; ?>"/></td>
            </tr>
            <tr>
			  ...
			  {
			  ?>
                <img src="<?php   echo $img; ?>" alt="Image 02" height="100" width="120"/>
                <?php  
			  }
