...
?>
    ...
    <div id="templatemo_main">
        ...
        <div id="content" class="faq float_r">
            ...
            <p>Youll  receive an email confirming that your order has been received. If you do not  receive an email confirmation, please check to see if the email address on your  order was entered correctly.</p>
