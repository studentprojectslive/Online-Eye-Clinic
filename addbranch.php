            ...
            <table width="660" border="0">
              <tr>
                ...
                <td width="300"><p>&nbsp;
                  ...
                  <p>
                    <input name="bname" class="right" type="text" id="bname" size="50" value="<?php   echo $branchname ;?>" />
                </p></td>
              </tr>
              ...
              <tr>
                ...
                <textarea name="description" id="description" cols="45" rows="5" ><?php   echo $desc ;?></textarea></td>
              </tr>
